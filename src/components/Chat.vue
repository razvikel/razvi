    ...
    <div class="container">
      <div class="notification">
        ...
        <div v-for="box in boxes">
          <question :box="box" style="margin-top: 5%"></question>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  data () {
    return {
      boxes: [
        {question: {name: "ישעיהו פלטיאל", content:"איך עושים ביטוח סיעוד נפלא?", time: new Date()}, answer: {content: "פונים למחלקת הסיעוד שלנו!", name: "אלי ויקלמן", time: new Date()}}
      ],
  ...
  methods: {
    sendQuestion() {
      ...
      this.boxes.push({question: newQuestion, answer: {content: "", time: new Date()}})
